...
SELECT id, creator_id, title, message, pixel_art, reveal_type, reveal_config, view_token, recipient_email, scheduled_open_at, scheduled_send_at, sent_at, single_open, opened_at, expires_at, published_at, created_at, updated_at FROM gifts
WHERE id = $1
LIMIT 1
`
